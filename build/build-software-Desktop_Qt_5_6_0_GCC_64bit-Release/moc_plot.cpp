...
QT_MOC_LITERAL(1, 5, 12), // "mousePressed"
QT_MOC_LITERAL(2, 18, 0), // ""
QT_MOC_LITERAL(3, 19, 8), // "mousePos"
QT_MOC_LITERAL(4, 28, 13) // "mouseReleased"

    },
    "Plot\0mousePressed\0\0mousePos\0mouseReleased"
};
...
void Plot::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plot::mousePressed)) {
                *result = 0;
                return;
            }
        }
        {
            typedef void (Plot::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plot::mousePos)) {
                *result = 1;
                return;
            }
        }
        {
            typedef void (Plot::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&Plot::mouseReleased)) {
                *result = 2;
                return;
            }
        }
...
const QMetaObject Plot::staticMetaObject = {
    { &QLabel::staticMetaObject, qt_meta_stringdata_Plot.data,
